...
{{- recipe(
  ...
  {"name":"扫帚飞行器","link":"#","icon":"/stylesheets/icons/broom_glider.jpg"}
) -}}
<p></p>
## 魔法扫帚
...
{{- recipe(
  ...
  {"name":"相机","link":"#","icon":"/stylesheets/icons/camera.jpg"}
) -}}
<p></p>
## 深潜头盔
...
{{- recipe(
  ...
  {"name":"磁性指南针（末地）","link":"#","icon":"/stylesheets/icons/Lodestone_Compass.gif"}
) -}}
<p></p>
## 闪光靴子
...
{{- recipe(
  ...
  {"name":"魔法剑","link":"#","icon":"/stylesheets/icons/magicsword.jpg"}
) -}}
<p></p>
## 魔法火炬
...
{{- recipe(
  ...
  {"name":"魔法火炬","link":"#","icon":"/stylesheets/icons/magictorch.jpg"}
) -}}
<p></p>
## 大师剑
...
{{- recipe(
  ...
  {"name":"镜之盾","link":"#","icon":"/stylesheets/icons/mirrorshield.jpg"}
) -}}
<p></p>
## 下界指南针
...
{{- recipe(
  ...
  {"name":"磁性指南针（下界）","link":"#","icon":"/stylesheets/icons/Lodestone_Compass.gif"}
) -}}
<p></p>
## 磁性指南针
<p></p>
{{- recipe(
  ...
  {"name":"磁性指南针","link":"#","icon":"/stylesheets/icons/Lodestone_Compass.gif"}
) -}}
<p></p>
## 兔子靴子
...
魔力恢复 -10% + 速度 Ⅲ + 跳跃提升 Ⅹ + 摔落保护 Ⅴ

## 法术书

另一种施法的方式，右键会打开你已经学会的法术列表，把它们放到背包里面就可以直接调用。右键附魔台进行升级操作。
...
魔力增幅 +30% + 魔力恢复 + 20% + SP 获得增幅 +50% + 魔法保护 Ⅰ + 药水保护 Ⅰ
...
{{- recipe(
  ...
  {"name":"魔力护符","link":"#","icon":"/stylesheets/icons/talisman.jpg"}
) -}}
<p></p>
## 法杖
...
{{- recipe(
  ...
  {"name":"法杖","link":"#","icon":"/stylesheets/icons/wand.jpg"}
) -}}
<p></p>
## 巫师靴子
<p></p>
